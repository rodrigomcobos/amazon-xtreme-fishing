...
const Accommodations = () => {
    ...
    return (
        <section className="relative mb-8 sm:mb-16">
            ...
            <div className="relative max-w-[90%] lg:max-w-[90%] mx-auto -mt-24 bg-white ring-1 ring-tertiary/25 bg-gradient-to-b from-white to-tertiary/5 rounded-lg shadow-lg p-8 md:p-12">
                {/* Indicators */}
