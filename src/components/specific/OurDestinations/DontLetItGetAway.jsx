        ...
        <section className="relative w-full">
            ...
            <div className="sm:absolute sm:inset-0 flex items-start justify-center sm:pt-16 pt-8 px-4 relative z-10 ">
                <div className="text-center max-w-3xl sm:bg-transparent p-4 sm:p-0 rounded-lg sm:rounded-none">
                    {/* Heading Section */}
                    <p className="text-sm sm:text-base font-dmsans text-gray-700 mb-1">
                        DON'T LET THIS ONE GET AWAY!
                    </p>
                    <hr className='w-[65%] sm:w-[40%] border-t-2 border-fifth mb-4 mx-auto' />
                    <h2 className="text-4xl sm:text-6xl font-roxale text-tertiary font-bold mb-4">
                        2025 PRIME WEEKS
                    </h2>

                    {/* Description */}
                    <p className="text-gray-600 text-sm sm:text-base font-dmsans mb-8 max-w-2xl mx-auto">
            ...
            <div className="relative w-full h-[320px] sm:h-[700px] -mt-24 sm:mt-0">
                <img
